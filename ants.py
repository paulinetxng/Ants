...
class Ant(Insect):
    ...
    def buff(self):
        ...
        while place is not None:
            ...
            if place.ant != None: #and not place.ant.buffed:
                ...
                elif place.ant.buffed and place.ant.is_container() and place.ant.contained_ant and not place.ant.contained_ant.buffed:
                    place.ant.contained_ant.damage *= 2
                    place.ant.contained_ant.buffed = True
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while not place.is_hive():
            if place.bees != [] and (self.min_range <= range_count <= self.max_range):
...
# END Problem EC
    ...
    def __init__(self, health=1):
        ...
        super().__init__(health)
        if not self.is_queen: # checks if there's no queen currently present
    ...
    def reduce_health(self, amount):
        ...
        super().reduce_health(amount)
        if self.true_queen and self.health <= 0:
            bees_win()
